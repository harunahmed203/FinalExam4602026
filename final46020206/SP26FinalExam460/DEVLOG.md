...
relic rooms and generate it either using a vector or some other way to print it out to keep track.
I will also attempt to keep it randokmly genretaed to make suremy code works through testing ._
._
...
_My first hurdle when dealing with my code is test my functions for part 2 and 3
